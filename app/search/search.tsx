...
/**
 * A screen component for searching and selecting coaches
 * @returns {JSX.Element} The rendered coach search interface
 */
const FindCoachScreen = () => {
    ...
    /**
     * Performs a search for coaches based on the selected filters
     */
    ...
    /**
     * Navigates to the book training screen for the selected coach
     * @param c - The coach to book a training with
     */
    ...
    /**
     * Navigates back and clears invited trainings in AsyncStorage
     */
        ...
        <View style={style.container}>
            ...
            <ScrollView>
                {coaches.map((c: SearchCoachDTO, idx: number) => (
                    <CoachCard key={idx} coach={c} onBook={handleBook} />
                ))}
            </ScrollView>
...
/**
 * Creates styles for the FindCoachScreen component based on the provided theme
